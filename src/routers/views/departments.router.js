...
router.get("/departments", async (req, res) => {
  ...
  res.render("./departments/departments_list", {
...
router.get("/post/departments", (req, res) => {
  res.render("./departments/post_department", { title: "Alta de departamentos 🖐️" });
});

router.get("/delete/departments", (req, res) => {
  res.render("./departments/delete_department", { title: "Baja de departamentos 🖐️" });
});
